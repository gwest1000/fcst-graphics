...
class HrdpsTemperatureTests(unittest.TestCase):
    ...
    def test_model_region_assignments_match_requested_products(self) -> None:
        self.assertEqual(temperature.region_keys_for_model("west"), ("sw", "se", "ne"))
        self.assertEqual(temperature.region_keys_for_model("continental"), ("bc",))

        temperature.set_model("west")
        self.assertEqual(temperature.output_prefix("sw"), "hrdps_west_temperature_sw")
    ...
    def test_one_west_field_is_reused_for_all_three_regional_frames(self) -> None:
        ...
        self.assertEqual(
            ...
            {
                "hrdps_west_temperature_sw_20260724T00Z_f000.png",
                "hrdps_west_temperature_se_20260724T00Z_f000.png",
                "hrdps_west_temperature_ne_20260724T00Z_f000.png",
            },
        )
