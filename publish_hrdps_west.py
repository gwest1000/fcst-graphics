...
PRODUCTS: dict[str, ProductConfig] = {
    ...
    "ecmwf_ensemble_spread_500": ProductConfig(
        ...
        label="50.0kPa Hgt Mn|SD",
        category="Upper Levels",
        plot_type="50.0kPa Hgt Mn|SD",
        area="North America",
        model="ECMWF ENS",
        description="ECMWF 51-member ensemble-mean 500 hPa geopotential height lightly smoothed and contoured every 0.06 km, with ensemble standard deviation shaded and contoured from 0.005 to 0.30 km. Forecasts are 3-hourly through F144 and 6-hourly through F360.",
